...
<img src="/guido-git-worktrees.png" alt="Guido van Rossum quote on worktrees" />
...
so you can work on one branch then switch to another branch without clobbering the changes you have made in the current branch.
...
<Info>
    Take a look at the `.git` file in your worktrees. Unlike what you would find in normal repos, it is a file that links to your original `.git` file.
</Info>
